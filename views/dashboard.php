      ...
      <table class="table table-hover align-middle">
        ...
        <tbody>
          ...
          <td>
            ...
            ?>
            <a href="edit-user.php" class="btn btn-outline-warning" title="Edit"><i class="far fa-pen-to-square"></i></a>
            <a href="delete-user.php" class="btn btn-outline-danger" title="Delete"><i class="far fa-trash-can"></i></a>
            <?php
            }
            ?>
          </td>
